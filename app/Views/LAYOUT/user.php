...
<link href="https://cdn.jsdelivr.net/npm/select2@4.0.13/dist/css/select2.min.css" rel="stylesheet" />  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
      ...
      <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="USER/helpdesk/helpdesk-user" class="nav-link">Home</a>
          </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <a href="<?= site_url('PROFILE USER/profile'); ?>">
          ...
          <div class="info">
            <a href="<?= base_url('PROFILE USER/profile'); ?>" class="d-block"
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">            
            <li class="nav-item">
              <a href="<?= base_url('USER/helpdesk/helpdesk-user') ?>" class="nav-link">
