      ...
      <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="PROGRESS TRACK/dashboard/home" class="nav-link">Home</a>
          </li>
        </ul>
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
          <div class="image">
            <a href="<?= site_url('PROFILE PIC/profile'); ?>">
          ...
          <div class="info">
            <a href="<?= base_url('PROFILE PIC/profile'); ?>" class="d-block"
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            <!-- Documentation IT -->
            <li class="nav-header" style="color: #32cd32;">Progress Track</li> <!-- Warna hijau terang -->
            <!-- Home -->
            <li class="nav-item">
              <a href="<?= base_url('PROGRESS TRACK/dashboard/home') ?>" class="nav-link">
            ...
            <li class="nav-item">
              <a href="<?= base_url('PROGRESS TRACK/helpdesk/helpdesk-pic') ?>" class="nav-link">
            ...
            <!-- Employee -->
            <li class="nav-header" style="color: #32cd32;">Employee</li> <!-- Warna hijau terang -->

            <li class="nav-item">
              <a href="EMPLOYEE/pic/pic-IT" class="nav-link">
            ...
            <!-- GROUP -->
            <li class="nav-item">
              <a href="EMPLOYEE/group/group-pic" class="nav-link">
    ...
    <script>
      document.addEventListener("DOMContentLoaded", function () {
        ...
        function autoHideNotifications() {
          ...
          }, 30000); // 30 detik (sesuaikan jika perlu)
        }
