      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="ORGANIZE/employee/history" class="nav-link">
                <?php if (empty($historyEmployeeIcon)): ?>
                  <i class="fas fa-spinner fa-spin nav-icon" id="historyEmployeeIconSpinner" style="color: #ff4500;"></i>
                  <!-- Warna oranye -->
                  <i class="fas fa-user-times nav-icon d-none" id="historyEmployeeIconFinal" style="color: #ff4500;"></i>
                  <!-- Warna oranye -->
                <?php else: ?>
                  <i class="fas fa-user-times nav-icon" style="color: #ff4500;"></i> <!-- Warna oranye -->
                <?php endif; ?>
            ...
            <!-- GROUP -->
            <li class="nav-item">
              <a href="ACCOUNT MANAGER/group/group-manager" class="nav-link">
                <?php if (empty($groupIcon)): ?>
                  <i class="fas fa-spinner fa-spin nav-icon" id="groupIconSpinner" style="color: rgb(40, 135, 152);"></i>
                  <!-- Warna biru -->
                  <i class="fas fa-users nav-icon d-none" id="groupIconFinal" style="color: rgb(40, 135, 152);"></i>
                  <!-- Warna biru -->
                <?php else: ?>
                  <i class="fas fa-users nav-icon" style="color: rgb(40, 135, 152);"></i> <!-- Warna biru -->
                <?php endif; ?>
                <p>GROUP</p>
              </a>
            </li>
            ...
            <!-- HISTORY -->
            <li class="nav-item">
              <a href="<?= base_url('ACCOUNT MANAGER/activity/history') ?>" class="nav-link">
                <?php if (empty($historyIcon)): ?>
                  <i class="fas fa-spinner fa-spin nav-icon" id="historyIconSpinner" style="color: #FF6347;"></i>
                  <!-- Warna merah tomat -->
                  <i class="fas fa-history nav-icon d-none" id="historyIconFinal" style="color: #FF6347;"></i>
                  <!-- Warna merah tomat -->
                <?php else: ?>
                  <i class="fas fa-history nav-icon" style="color: #FF6347;"></i> <!-- Warna merah tomat -->
                <?php endif; ?>
                <p>HISTORY</p>
              </a>
            </li>
