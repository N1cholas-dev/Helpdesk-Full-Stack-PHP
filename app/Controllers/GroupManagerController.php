...
class GroupManagerController extends BaseController
{
    public function index()
    {
        ...
        return view('ACCOUNT MANAGER/group/group-manager', ['groups' => $groups]);
    }
    ...
    {
        return view('ACCOUNT MANAGER/group/create');
    }
    ...
    public function store()
    {
        ...
        return redirect()->to('ACCOUNT MANAGER/group/group-manager')->with('success', 'Group created successfully!');
    }
    ...
    public function edit($group_id)
    {
        ...
        return view('ACCOUNT MANAGER/group/edit', [
            'group' => $group,
    ...
    public function save($group_id = null)
    {
        ...
        return redirect()->to('ACCOUNT MANAGER/group/group-manager')->with('success', 'Group saved successfully!');
    }
    ...
    public function removeMember($group_id, $employee_id)
    {
        ...
        try {
            ...
            return redirect()->to('ACCOUNT MANAGER/group/edit/' . $group_id)->with('success', 'Member removed successfully!');
        } catch (\Exception $e) {
    ...
    public function detail($id)
    {
        ...
        return view('ACCOUNT MANAGER/group/detail', [
            'group' => $group,
            'groupEmployees' => $groupEmployees,
            'employeeModel' => $employeeModel
        ]);
    ...
    public function delete($group_id)
    {
        ...
        return redirect()->to('ACCOUNT MANAGER/group/group-manager')->with('success', 'Group successfully deleted.');
    }
}
