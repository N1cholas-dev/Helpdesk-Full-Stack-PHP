        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form action="<?= base_url('ACCOUNT MANAGER/admin/update/' . $admin['id']) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row">
                                <!-- Username Field -->
                            ...
                            <div class="d-flex mt-3" style="gap: 10px;">
                                ...
                                <a href="<?= base_url('ACCOUNT MANAGER/admin/admin-manager') ?>"
...
<!-- Tambahkan SweetAlert script dan logic flash message -->
