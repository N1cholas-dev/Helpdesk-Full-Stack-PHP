    ...
    <div class="container-fluid">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text">Jumlah Harian</p>
                                <p class="card-text">
                                    Tiket: <?= $ticketsDaily['ticket_count'] ?? 0 ?> tiket
                                </p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text">Jumlah Mingguan</p>
                                <p class="card-text">Tiket: <?= $ticketsWeekly['ticket_count'] ?> tiket</p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text">Jumlah Bulanan</p>
                                <p class="card-text">Tiket: <?= $ticketsMonthly['ticket_count'] ?> tiket</p>
                            </div>
                            <div>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <p class="card-text">Jumlah Tahunan</p>
                                <p class="card-text">Tiket: <?= $totalTicketsAllYears['ticket_count'] ?> tiket</p>
                            </div>
                            <div>
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-teal text-white"> <!-- Row 2 - Warna Teal -->
                        <h5 class="card-title mb-0">Pengukur Masalah</h5>
                    </div>
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-teal text-white">
                        <h5 class="card-title mb-0">Pengukur Tiket</h5>
                    </div>
                    <div class="card-body text-center d-flex justify-content-center align-items-center"
                        style="height: 250px;">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-orange text-white">
                        <h5 class="card-title mb-0">Tiket Per-jam</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-orange text-white">
                        <h5 class="card-title mb-0">Tugas PIC Keseluruhan</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-purple text-white">
                        <h5 class="card-title mb-0">Jumlah Pembelian oleh Vendor</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-purple text-white">
                        <h5 class="card-title mb-0">Jumlah Tiket PIC</h5>
                    </div>
                    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-cyan text-dark">
                        <h5 class="card-title mb-0">Jumlah Status Tiket</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-lg-6 col-md-12 mb-4">
                <div class="card">
                    <div class="card-header bg-cyan text-dark">
                        <h5 class="card-title mb-0">Jumlah Tiket Bulanan</h5>
                    </div>
                    <div class="card-body">
...
<script type="text/javascript">
    ...
    function drawGaugeChart() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Label', 'Value'],
            ['Tiket', 0] // Mulai dari 0 untuk animasi
        ]);
    ...
    function drawGaugeSubjects() {
        ...
        var data = google.visualization.arrayToDataTable([
            ['Label', 'Value'],
            ['Masalah', 0] // Mulai dari 0 untuk animasi
        ]);
