        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST"
                            action="<?= site_url('USER/helpdesk/update/' . $ticket['id']) ?>">
                            <?= csrf_field(); ?>
                            ...
                            <div class="mb-3">
                                        ...
                                        <select id="subject_dropdown" name="subject_dropdown"
                                            ...
                                            foreach ($subjects as $subject):
                                                ...
                                                <option value="<?= htmlspecialchars($subject['description']); ?>"
                                                    <?= (isset($ticket['subject']) && $ticket['subject'] == $subject['description']) ? 'selected' : ''; ?>>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="problem_description" name="problem" class="form-control"
                                        value="<?= isset($ticket['problem_id']) ? '' : htmlspecialchars($ticket['problem_id']); ?>"
...
<script>
    ...
    function syncProblemInput() {
        ...
        let input = document.getElementById("problem_description");
        input.value = dropdown.options[dropdown.selectedIndex].getAttribute("data-description") || "";
    }
