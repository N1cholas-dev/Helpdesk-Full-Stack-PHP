        ...
        <div class="row">
            <div class="col-12">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body">
                        <form action="ACCOUNT MANAGER/group/group-manager/save/<?= $group['id'] ?>" method="post">
                            ...
                            <?php foreach ($groupEmployees as $groupEmployee): ?>
                                ...
                                if ($employee):
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center">
                                        <?= $employee['name']; ?>
                                        <a href="<?= site_url('ACCOUNT MANAGER/group/edit/remove-member/' . $group['id'] . '/' . $employee['id']); ?>"
        ...
        $('#addMemberBtn').click(function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: "<?= site_url('ACCOUNT MANAGER/group/edit/add-member') ?>",
                        type: "POST",
                            ...
                            if (response.success) {
                                ...
                                let newMember = `
                                    <li class='list-group-item d-flex justify-content-between align-items-center' data-employee-id='${response.employee.id}'>
                                        ...
                                        <a href="ACCOUNT MANAGER/group/edit/remove-member/${groupId}/${response.employee.id}" class="btn btn-danger btn-sm remove-member-btn">
                                            <i class="fas fa-trash-alt"></i> Remove
                                        </a>
                                    </li>`;
