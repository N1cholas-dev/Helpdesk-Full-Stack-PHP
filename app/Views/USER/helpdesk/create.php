        ...
        <div class="row mt-3">
            <div class="col-12">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        <form method="POST" action="<?= base_url('USER/helpdesk/store') ?>"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    ...
                                    <label for="subject_input" class="visually-hidden">Subject Input</label>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex flex-column">
                                    <select id="problem_dropdown" name="problem_id" class="form-select select2 mb-2"
                                        style="max-width: 300px;" onchange="toggleProblemInput();">
                                        <option value="" disabled selected>-- Select Problem --</option>
                                        <?php foreach ($problems as $problem): ?>
                                            <option value="<?= esc($problem['id']); ?>"><?= esc($problem['description']); ?>
                                            </option>
                                        <?php endforeach; ?>
                                    </select>

                                    <label for="problem_input" class="visually-hidden">Problem Input</label>
                            ...
                            <div class="mb-3">
                                ...
                                <a href="USER/helpdesk/helpdesk-user" class="btn btn-danger px-4 py-2">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        function toggleInput(dropdown, input) {
            input.disabled = !!dropdown.value; // Nonaktifkan input jika dropdown memiliki nilai
        }

        function toggleDropdown(input, dropdown) {
            dropdown.disabled = !!input.value.trim(); // Nonaktifkan dropdown jika input memiliki nilai
        }
