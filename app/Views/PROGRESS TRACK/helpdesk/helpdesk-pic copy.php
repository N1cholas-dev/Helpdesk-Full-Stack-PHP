            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap">
                        ...
                        <a href="<?= base_url('PROGRESS TRACK/helpdesk/create') ?>" class="btn-create-ticket">
                            <i class="fas fa-ticket-alt"></i>
                            <span>Create Ticket</span>
                        </a>

                        <!-- Filter Status tanpa form -->
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select id="categoryFilter" class="form-control" style="width: 250px;">
                                <option value="">Semua</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="subcategoryFilter" class="form-control" style="width: 250px;">
                                <option value="">Semua</option>
                                ...
                                <option value="TAMBAH VENDOR / CUSTOMER / ITEM / UOM">TAMBAH VENDOR / CUSTOMER / ITEM /
                                    UOM</option>
                        ...
                        <div class="mb-3">
                            ...
                            <select id="departmentFilter" class="form-control" style="width: 250px;">
                                <option value="">Semua</option>
                        ...
                        <!-- Table Container -->
                        <div class="table-responsive" style="background-color: #ffff; overflow:auto;">
                                ...
                                <tbody>
                                    <?php foreach ($tickets as $ticket): ?>
                                        <tr>
                                            ...
                                            <!-- Actions -->
                                            <td>
                                                <a href="PROGRESS TRACK/helpdesk/edit/<?= $ticket['id'] ?>"
